...
<div class="code-block">
    <div class="code-header">
        ...
        <button class="expand-button" aria-label="Expand all lines">
            ...
            <!-- Default: Hidden Fold Icon (Collapse) -->
            <svg aria-hidden="true" focusable="false" class="octicon fold-icon hidden" 
                viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
                <path d="M10.896 2H8.75V.75a.75.75 0 0 0-1.5 0V2H5.104a.25.25 0 0 0-.177.427l2.896 2.896a.25.25 0 0 0 .354 0l2.896-2.896A.25.25 0 0 0 10.896 2Z"></path>
            </svg>
        </button>
